# -*- coding: utf-8 -*-
"""
Created on Mon Jan 21 22:20:24 2019
...
'''
def extract_conversations(convs,id2line,path='D:\Study\BE_Electronics\Semester8\FYP_Phase2\Easy\copy\data/'):
    idx = 0
    for conv in convs:
...
'''
def prepare_seq2seq_files(questions, answers, path='D:\Study\BE_Electronics\Semester8\FYP_Phase2\Easy\copy\data/',TESTSET_SIZE = 30000):
